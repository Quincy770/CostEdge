export default {
    ...
    {index: 6, label: 'E-Commerce Shop', url: '/apps/orders/shop', labelIcon: 'ShoppingCartIcon', highlightAction: true},
    {index: 7, label: 'E-Commerce Wish List', url: '/apps/orders/wish-list', labelIcon: 'HeartIcon', highlightAction: false},
		{index: 8, label: 'E-Commerce Checkout', url: '/apps/orders/checkout', labelIcon: 'CreditCardIcon', highlightAction: false},
