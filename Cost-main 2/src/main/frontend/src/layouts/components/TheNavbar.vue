<template>
  <div class="relative" style="">
    <div class="">
      ...
      <vs-navbar  :color="navbarColor">
        <h2 class="ml-10">Cost Edge</h2>
        <div class="ml-10" style="width: 300;"></div>
        <div class="ml-10" style="width: 200;"></div>
        <div class="ml-10" style="width: 200;"></div>
        <div class="ml-10" style="width: 200;"></div>
        <div class="ml-10" style="width: 200;"></div>
        <div class="ml-10" style="width: 300;"></div>
            ...
            <template v-if="cartItems.length">
              ...
              >
                <ul class="bordered-items">
                  ...
                  >
                    <div
                      class="ml-6 vx-col w-4/5 pr-4 pl-2 py-4 flex flex-col justify-center"
                      @click="$router.push('/pages/orders/checkout')"
                    >
                      <span
                      ...
                      <div class="flex items-center justify-between">
                        ...
                        <feather-icon
                          ...
                          class="ml-16 hover:text-white bg-danger p-1 rounded-lg"
          ...
          <vs-dropdown vs-custom-content vs-trigger-click class="cursor-pointer">
            ...
            <vs-dropdown-menu class="vx-navbar-dropdown">
              <ul style="min-width: 9rem">
                ...
                <!-- <li
                  class="flex py-2 px-4 cursor-pointer hover:bg-primary hover:text-white"
                  @click="$router.push('/pages/orders/wish-list')"
                >
          ...
          connect() {
            ...
            this.stompClient.connect(
              ...
              frame => {
                ...
                //   alert(JSON.stringify(JSON.parse(tick.body)))
