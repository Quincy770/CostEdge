<template>
  <div id="main-div" class="vx-row">
    ...
    <div class="vx-col w-full mb-base">
      <vx-card id="card-id" :title="$t('editSupplier')">
        <vx-card id="internal-card" class="mt-5" title no-shadow card-border>
          ...
          <div class="vx-row mt-10">
            ...
            <div class="vx-col sm:w-1/6 w-full mb-6">
              <div class="vx-col w-full">
                  <br>
              <vs-button @click="editSupplier" color="success" class="mr-3 mb-2">{{$t('update')}}</vs-button>
            </div>
            </div>
          </div>
          ...
          <div class="vx-row">
            <!-- <div class="vx-col w-full">
              <vs-button @click="editSupplier" color="success" class="mr-3 mb-2">{{$t('save')}}</vs-button>
            </div> -->
          </div>
...
export default {
  ...
  methods: {
    fetchSupplier(){
      this.$http.get("/supplier/"+this.supplierId)
             .then(response => {
