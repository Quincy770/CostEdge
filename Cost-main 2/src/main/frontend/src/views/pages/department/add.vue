      ...
      <vx-card id="card-id" :title="$t('addDepartment')">
        <vx-card id="internal-card" class="mt-5" title no-shadow card-border>
          ...
          <div class="vx-row mt-2">
            <div class="vx-col sm:w-1/4 md:w-full lg:w-2/3 xl:w-2/3 mb-6">
    
            </div>
              <vs-button v-if="isGranted('addDepartment')" @click="addDepartment" color="success" class="mr-3 mb-2">{{$t('save')}}</vs-button>
          </div>
        </vx-card>
      </vx-card>
    </div>
