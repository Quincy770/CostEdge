	...
	protected void configure(HttpSecurity http) throws Exception {
		...
		.antMatchers("/accounts/changestatus/**", "/accounts/users/**", "/accounts/customers/**",
		    ...
		    "/pricelist/**", "/order/filter/**", "/order/changeorderstatus/**", "/order/sell/**",
		     "/order/filterbypaymnetstatus/**", "/company/search",
		    "/inventorytransaction/**", "/accounts/search/**", "/gs-guide-websocket/info","/departments/**","/products/**"
		,"/region/**")
		.hasAnyRole("ADMIN");

		http.authorizeRequests()
				.antMatchers( "/order/myorderhistory/**","/inventory/selected-items/**")
				.hasAnyRole("CUSTOMER");
